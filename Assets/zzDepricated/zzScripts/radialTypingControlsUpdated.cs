...
/// </summary>
public class radialTypingControlsUpdated : MonoBehaviour
{
    ...
    const int numLeftScrollwheeltypingSets = 3;
    const int numLeftScrollwheelsides = 8;
//    [SerializeField] int numLeftScrollwheelsideOptions = 4;
    [SerializeField] float distanceFromCenter = 1.5f;

    int[] typingSetCapsMappings = new int[numLeftScrollwheeltypingSets] { 1, 0, 2 };
    int[] typingSetChangeSetMappings = new int[numLeftScrollwheeltypingSets] { 2, 2, 0 };
